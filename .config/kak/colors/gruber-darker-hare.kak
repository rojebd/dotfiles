# gruber-dark theme
# This makes operators such as ! red so they are easier to see since ! operator
# is an error handling operator so that way I can see where errors could occur more
# easily
